...
PHASE_CONFIG = {
    ...
    GamePhase.HUNTER_REMINDER_BEGIN: {"is_global": True, "applicable_roles": [], "group": "shoot_reminder"},
    GamePhase.WOLF_KING_REMINDER_BEGIN: {"is_global": True, "applicable_roles": [], "group": "shoot_reminder"},
    GamePhase.SHOOT_BEGIN: {"is_global": True, "applicable_roles": [], "group": "shoot_skill"},
    GamePhase.SHOOT_REMINDER: {"is_global": False, "applicable_roles": [Role.HUNTER, Role.WOLF_KING], "group": "shoot_reminder"},
